...
extern si_t *si_attach(uint pcidev, void *regs, uint bustype, void *sdh, char **vars, uint *varsz);
...
//static __inline void * si_seci_init(si_t *sih, uint8 use_seci) {return NULL;}
