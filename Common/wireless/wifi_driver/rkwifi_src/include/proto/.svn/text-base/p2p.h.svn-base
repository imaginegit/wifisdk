...
__packed struct wifi_p2p_info_se_s {
...
__packed struct wifi_p2p_intent_se_s {
...
__packed struct wifi_p2p_cfg_tmo_se_s {
...
__packed struct wifi_p2p_status_se_s {
...
__packed struct wifi_p2p_ext_se_s {
...
__packed struct wifi_p2p_intintad_se_s {
...
__packed struct wifi_p2p_channel_se_s {
	uint8   eltId;      /* SE ID: P2P_SEID_STATUS */
	uint8   len[2];     /* SE length not including eltId, len fields */
...
__packed struct wifi_p2p_chanlist_entry_s {
	uint8   band;                       /* Regulatory Class (band) */
...
__packed struct wifi_p2p_chanlist_se_s {
	uint8   eltId;      /* SE ID: P2P_SEID_STATUS */
	uint8   len[2];     /* SE length not including eltId, len fields */
...
__packed struct wifi_p2p_devinfo_se_s {
...
__packed struct wifi_p2p_cid_fixed_s {
	uint8   len;
...
__packed struct wifi_p2p_devid_se_s {
	uint8   eltId;
	uint8   len[2];
...
__packed struct wifi_p2p_mgbt_se_s {
...
__packed struct wifi_p2p_grpinfo_se_s {
...
__packed struct wifi_p2p_action_frame {
...
__packed struct wifi_p2p_pub_act_frame {
...
__packed struct wifi_p2p_noa_desc {
...
__packed struct wifi_p2p_noa_se {
...
__packed struct wifi_p2psd_adp_tpl {
...
__packed struct wifi_p2psd_adp_ie {
...
__packed struct wifi_p2psd_nqp_query_vsc {
...
/* Service Request TLV */
__packed struct wifi_p2psd_qreq_tlv {
...
__packed struct wifi_p2psd_qreq_frame {
...
__packed struct wifi_p2psd_gas_ireq_frame {
...
__packed struct wifi_p2psd_qresp_tlv {
	uint16  len;                /* Length: 5 plus size of Query Data */
	uint8   svc_prot;           /* Service Protocol Type */
	uint8   svc_tscid;          /* Service Transaction ID */
...
__packed struct wifi_p2psd_qresp_frame {
	uint16  info_id;    /* Info ID: 0xDDDD */
...
__packed struct wifi_p2psd_gas_iresp_frame {
...
__packed struct wifi_p2psd_gas_cresp_frame {
	uint16  status;         /* Value defined in Table 7-23 of IEEE P802.11u */
...
__packed struct wifi_p2psd_gas_pub_act_frame {
