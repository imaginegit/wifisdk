...
#define SDIODDMAREG32(h, dir, chnl) \
	((dir) == DMA_TX ? \
	 (void *)(uint)&((h)->regs->dma.sdiod32.dma32regs[chnl].xmt) : \
	 (void *)(uint)&((h)->regs->dma.sdiod32.dma32regs[chnl].rcv))

#define SDIODDMAREG64(h, dir, chnl) \
	((dir) == DMA_TX ? \
	 (void *)(uint)&((h)->regs->dma.sdiod64.dma64regs[chnl].xmt) : \
	 (void *)(uint)&((h)->regs->dma.sdiod64.dma64regs[chnl].rcv))
...
#define PCMDDMAREG(h, dir, chnl) \
	((dir) == DMA_TX ? \
	 (void *)(uint)&((h)->regs->dma.pcm32.dmaregs.xmt) : \
	 (void *)(uint)&((h)->regs->dma.pcm32.dmaregs.rcv))
...
#define SDIODFIFOREG(h, corerev) \
	(SDIODREV_LT((corerev), 1) ? \
	 ((dma32diag_t *)(uint)&((h)->regs->dma.sdiod32.dmafifo)) : \
	 ((dma32diag_t *)(uint)&((h)->regs->dma.sdiod64.dmafifo)))

#define PCMDFIFOREG(h) \
	((dma32diag_t *)(uint)&((h)->regs->dma.pcm32.dmafifo))
